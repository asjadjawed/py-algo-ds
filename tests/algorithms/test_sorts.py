...
from py_algo_ds.algorithms.sorts import (
    bubble_sort,
    insertion_sort,
    quicksort,
    selection_sort,
...
@pytest.mark.parametrize(
    "algorithm", [selection_sort, bubble_sort, quicksort, insertion_sort]
)
...
@pytest.mark.parametrize("algorithm", [selection_sort, bubble_sort, quicksort])
